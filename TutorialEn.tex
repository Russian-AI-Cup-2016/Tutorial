...
The main personal goal of every wizard is to collect the highest possible number of points.
The title of winner of the game, as well as all the other places are
distributed in accordance with the number of points. Two or more players can share one place if their scores are equal. The player gets
...
\begin{itemize}
 \item In \textbf{Round $1$} you will learn the rules of the game and basic controls of a Wizard. Each game in this stage
            ...
            in the championship, a Wizard cannot damage friendly minions and structures. Round $1$, like all subsequent stages, consists of
...
\begin{tabular}{| l | l | l | l | l | l | l |}
            ...
            Max Energy                          & $100$\footnotemark[5] & $100$ & $100$ & $1000$\footnotemark[6] & $2000$\footnotemark[6] & $6-36$  \\
            Eyesight radius                     & $600$                     & $400$ & $400$ & $600$             & $800$                     & ---    \\
            Long-range combat distance\footnotemark[7] & $500$                  & ---   & $300$ & $1000$                & $100$                     & ---    \\
            Close combat distance\footnotemark[8] & $70$                & $50$  & ---   & $600$                     & $800$                     & ---    \\
            Interval between attacks                & $30$\footnotemark[9]  & $60$  & $30$  & $240$                         & $240$                     & ---    \\
            Damage from one attack                              & $12$\footnotemark[10] & $12$  & $6$   & $24$              & $36$                      & ---    \\
            \hline
\end{tabular}
...
A building attack does not create a projectile. Damage is caused instantly due to a magic energy charge.
...
\begin{itemize}
            ...
            The total bonus from the four skills is $20\%$, while aura adds $10\%$ movement to friendly wizards
...
\begin{itemize}
            ...
            \item \texttt{STAFF}. \textit{Strike with the staff.} The attack will strike all alive objects in the sector from $-\pi / 12$ to $\pi / 12$.
            ...
            \hline
            Delay           & $60$\footnotemark[12] & $90$                  & $120$         \\
            Price               & $12$                      & $36$          & $48$          \\
            \hline
            \end{tabular}
            ...
            \item All wizards turn for the angle set by the strategy.
\end{itemize}
...
Each $2500$ ticks a bonus may appear on the map. If there is at least one bonus on the map already, a new bonus will not be created. The bonus
is created at a randomly chosen point from two possible: $(1200, 1200)$ or $(2800, 2800)$. If any part of the area where the bonus should appear is
already occupied by a wizard, then the simulator tries to create the bonus in the different point from the list. In case of failure, the creation of the bonus will be postponed till the end
...
\begin{itemize}
            ...
            integer.
            \item Collection of any bonus gives $100$ points/experience points.
