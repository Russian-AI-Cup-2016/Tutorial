...
\sld
\item{{\bf Returns} - 
Возвращает уникальынй идентификатор статуса. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
Возвращает идентификатор игрока, волшебник которого наложил данный статус, или $\{$code -1$\}$. 
}%end item
\end{itemize}
}%end item
...
\sld
\item{{\bf Returns} - 
Возвращает идентификатор волшебника, наложившего данный статус, или $\{$code -1$\}$. 
}%end item
\end{itemize}
}%end item
\end{itemize}
